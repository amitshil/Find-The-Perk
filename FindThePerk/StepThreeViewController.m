...
optionArray = [[NSMutableArray alloc]initWithObjects:Option1_Ques3,Option2_Ques3,Option3_Ques3,Option4_Ques3, nil];
    ...
    tabIconImageView.image = [UIImage imageNamed:@"stepX3"];
    ...
    quation1.text =[NSString stringWithFormat:@"Q3: %@", QUESTION3];
...
-(void)OkButtonAction:(id)sender{
    StepFourViewController *pMainViewController = [[StepFourViewController alloc]initWithNibName:@"StepFourViewController" bundle:nil];
