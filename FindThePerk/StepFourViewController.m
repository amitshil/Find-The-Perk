...
optionArray = [[NSMutableArray alloc]initWithObjects:Option1_Ques4,Option2_Ques4,Option3_Ques4,Option4_Ques4, nil];
    ...
    tabIconImageView.image = [UIImage imageNamed:@"stepX4"];
    ...
    quation1.text =[NSString stringWithFormat:@"Q4: %@", QUESTION4];
...
-(void)OkButtonAction:(id)sender{
    StepFiveViewController *pMainViewController = [[StepFiveViewController alloc]initWithNibName:@"StepFiveViewController" bundle:nil];
